...
urlpatterns = [
    ...
    path('delete_leads_campaign/', DeleteLeadsFromCampaignAPIView.as_view(), name='delete_leads_campaign'),
    path('delete_leads/', views.delete_selected_lead, name='delete_leads'),
    ...
    path('leads/total/', TotalCampaignsAPIView.as_view(), name='total-leads'), 
]
